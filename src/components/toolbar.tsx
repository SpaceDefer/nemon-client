    ...
    return (
        <div className="flex w-[1150px] mt-4 items-center ">
            ...
            <div className="flex flex-grow-0 bg-white items-center p-2 shadow-sm rounded-lg border-2 mr-4">
                <p className="text-slate-600 text-sm font-semibold px-4 border-r-2 h-full">Sort by</p>
                <img src={DownSolid} className="h-[20px] ml-2"/>
            </div>
            <img src={DownloadSolid} className="h-[35px] flex-grow-0 hover:cursor-pointer" />
        </div>
    )
}