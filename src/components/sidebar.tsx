    ...
    return (
        <div className="h-screen w-[250px] bg-neutral-900 rounded-tr-[50px] pt-[150px] flex flex-col items-center">
            <div className="flex-grow w-[250px]">
                <div className={"flex border-l-4 h-12 pl-6 " +((currLocation=='machines')?"border-[#0bbe6e]":"border-neutral-900")}>
                    <Link to='/machines' className="flex items-center">
                        <img src={DisplaySolid} className="h-[20px] pr-[15px]" />
                        <p className="text-slate-50 text-sm">Machines</p>
                    </Link>
                </div>
                <div className={"flex border-l-4 h-12 pl-6 " +((currLocation=='applications')?"border-[#0bbe6e]":"border-neutral-900")}>
            ...
            <div className="flex-grow-0  border-t-[1px] border-t-slate-100  w-[200px]">
                <div className="flex py-6 items-center">
                    ...
                    <div className="flex flex-col">
                        <p className="text-slate-50 font-semibold text-sm">Admin</p>
                        <p className="text-slate-50 text-xs">192.168.0.1</p>
                    </div>
                </div>
                <div className="flex mb-2">
                    <img src={GearSolid} className="h-[20px] pr-[14px]" />
                    <p className="text-slate-50 text-sm font-semibold">Settings</p>
                </div>
